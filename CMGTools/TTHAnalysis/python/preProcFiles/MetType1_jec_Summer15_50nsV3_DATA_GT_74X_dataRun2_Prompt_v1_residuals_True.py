...
process.jec = cms.ESSource("PoolDBESSource",
    ...
    connect = cms.string('sqlite_file:'+os.path.expandvars('$CMSSW_BASE/src/CMGTools/RootTools/data/jec/Summer15_50nsV3_DATA.db')),
    toGet = cms.VPSet(cms.PSet(
        label = cms.untracked.string('AK4PF'),
        record = cms.string('JetCorrectionsRecord'),
        tag = cms.string('JetCorrectorParametersCollection_Summer15_50nsV3_DATA_AK4PF')
    ), 
        cms.PSet(
            label = cms.untracked.string('AK4PFchs'),
            record = cms.string('JetCorrectionsRecord'),
            tag = cms.string('JetCorrectorParametersCollection_Summer15_50nsV3_DATA_AK4PFchs')
        ))
)

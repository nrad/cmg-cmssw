...
process.slimmedMETs = cms.EDProducer("PATMETSlimmer",
    ...
    src = cms.InputTag("patPFMetT1"),
    t01Variation = cms.InputTag("slimmedMETs","","PAT"),
...
process.patMetModuleSequenceNoHF = cms.Sequence(process.patPFMetNoHF+process.genMetExtractor+process.patPFMetT1TxyNoHF+process.patPFMetT1NoHF+process.patPFMetTxyNoHF)
...
process.patMetModuleSequence = cms.Sequence(process.patPFMet+process.genMetExtractor+process.patPFMetT1Txy+process.patPFMetTxy+process.patPFMetT1)
...
process.fullPatMetSequence = cms.Sequence(process.patMetCorrectionSequence+process.patMetUncertaintySequence+process.patPFMet+process.genMetExtractor+process.patPFMetT1Txy+process.patPFMetTxy+process.patPFMetT1)

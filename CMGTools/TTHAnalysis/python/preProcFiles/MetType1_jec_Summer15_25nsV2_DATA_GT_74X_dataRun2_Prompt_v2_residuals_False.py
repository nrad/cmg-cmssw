...
process.shiftedPatJetEnDown = cms.EDProducer("ShiftedPATJetProducer",
    ...
    jetCorrInputFileName = cms.FileInPath('CMGTools/RootTools/data/jec/Summer15_50nsV4_DATA_UncertaintySources_AK4PFchs.txt'),
...
process.jec = cms.ESSource("PoolDBESSource",
    ...
    connect = cms.string('sqlite_file:'+os.path.expandvars('$CMSSW_BASE/src/CMGTools/RootTools/data/jec/Summer15_25nsV2_DATA.db')),
    toGet = cms.VPSet(cms.PSet(
        label = cms.untracked.string('AK4PF'),
        record = cms.string('JetCorrectionsRecord'),
        tag = cms.string('JetCorrectorParametersCollection_Summer15_25nsV2_DATA_AK4PF')
    ), 
        cms.PSet(

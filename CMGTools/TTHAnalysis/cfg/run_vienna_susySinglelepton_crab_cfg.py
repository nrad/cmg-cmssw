...
#QCD = [QCD_HT_100To250, QCD_HT_250To500, QCD_HT_500To1000, QCD_HT_1000ToInf]
#Bkg_other = [TTWJets, TTZJets, TTH ]
#Signal_other = [SMS_T1tttt_2J_mGl1500_mLSP100, SMS_T1tttt_2J_mGl1200_mLSP800]
#selectedComponents =QCD + Bkg_other + SingleTop + DYJetsM50HT + T5qqqqWW_vienna + Signal_other 
...
#preprocessor = CmsswPreprocessor("$CMSSW_BASE/python/JMEAnalysis/JetToolbox/test/jettoolbox_cfg.py")# % os.environ['CMSSW_BASE'])
